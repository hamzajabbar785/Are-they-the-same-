...
// it appears). "Same" means, here, that the elements in b are the elements in a squared, regardless of the 
// order.
...
const comp = (a,b) => {
    ...
    return newArr.sort().join("") === b.sort().join("")
}
...
const comp = (a,b) => {
    ...
    return a.map((el) => el*el).sort().join("") === b.sort().join("")
}